...
@Last Modified time : 2023/11/26-12:31
"""
...
class RoadLink:
    def __init__(self):
        self.pre_type: Optional[str] = None
        self.pre_id: Optional[int] = None
        self.pre_cont_point: Optional[str] = None
        self.suc_type: Optional[str] = None
        self.suc_id: Optional[int] = None
        self.suc_cont_point: Optional[str] = None
...
class Lane:
    ...
    def set_width(self, w_s=0.0, w_a=0.0, w_b=0.0, w_c=0.0, w_d=0.0):
        self.w_s = w_s
        self.w_a = w_a
        self.w_b = w_b
        self.w_c = w_c
